<template>
	<view>
		...
		<view class="list">
			...
			<view class="options">
				<view :class="['item',(selectItem&&selectItem.id==item.id)?'chargeActive':'']" v-for="(item,index) in dataList" :key="index" @click.stop="selectItem=item">
					<view>{{item.value}}元</view>
					<image v-if="item.couponIds?true:false" class="flag" src="../../static/image/cz.png"></image>
					<image v-if="(selectItem&&selectItem.id==item.id)?true:false"  class="select-flag" src="../../static/image/voice-select-yes@2x.png"></image>
				</view>
			</view>
		...
		<view class="pay">
			...
			<view class="menu border" @click.stop="payWay=1">
				...
				<image class="" :src="payWay==1?'/static/image/select_yes@2x.png':'/static/image/select_normal@2x.png'"></image>
			</view>
			<view class="menu" @click.stop="payWay=2">
				...
				<image class="" :src="payWay==2?'/static/image/select_yes@2x.png':'/static/image/select_normal@2x.png'"></image>
			</view>
		</view>
